    ...
    <ThemeProvider>
      <div className="nectar-header">
        <div className="nectar-header-left">
          ...
          <Button className="nectar-nav-item" onClick={onChangeConfiguration}>Home</Button>
          ...
          <Button className="nectar-nav-item" href="https://support.ehelp.edu.au/support/home">Help</Button>
        </div>
        <div className="nectar-header-right">
          <ButtonBase
            className={
              'nectar-avatar nectar-nav-item' +
              (isMenuOpen ? ' nectar-nav-item-selected' : '')
            }
            onClick={handleOpenMenu}
          >
            <Avatar className="nectar-avatar-picture">
              {userName[0].toUpperCase()}
            </Avatar>
            <span className="nectar-avatar-text">{userName}</span>
          </ButtonBase>
          <Menu
            className="nectar-header-menu"
          ...
          <Button className="nectar-header-menu" variant="outlined" startIcon={<ExitToAppIcon />} onClick={onClickLogout}>Logout</Button>
        </div>
      </div>
    </ThemeProvider>
  );
